<template>
    <div class="q-pa-md">
        <div class="q-gutter-md">
            <q-carousel v-model="skills" transition-prev="scale" transition-next="scale" swipeable animated
                control-color="white" navigation padding arrows height="300px"
                class="bg-warning text-white shadow-1 rounded-borders">
                <q-carousel-slide name="html" class="column no-wrap flex-center">
                    ...
                    <div class="q-mt-sm text-h4">HTML</div>

                </q-carousel-slide>
                <q-carousel-slide name="css" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                    ...
                    <div class="q-mt-sm text-h4">CSS</div>
                </q-carousel-slide>
                <q-carousel-slide name="js" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                    ...
                    <div class="q-mt-sm text-h4">JAVASCRIPT</div>

                </q-carousel-slide>
                <q-carousel-slide name="vue" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                    ...
                    <div class="q-mt-sm text-h4">VUE.JS</div>

                </q-carousel-slide>
                <q-carousel-slide name="nuxt" class="column no-wrap flex-center">
                    ...
                    <div class="q-mt-sm text-h4">NUXT.JS</div>

                </q-carousel-slide>
                <q-carousel-slide name="typescript" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                    ...
                    <div class="q-mt-sm text-h4">TYPESCRIPT</div>

                </q-carousel-slide>
                <q-carousel-slide name="sass" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                        <path fill="#f06292"
                    ...
                    <div class="q-mt-sm text-h4">SASS/LESS/SCSS</div>

                </q-carousel-slide>
                <q-carousel-slide name="tailwind" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                        <path fill="#00acc1"
                            d="M24,9.604c-6.4,0-10.4,3.199-12,9.597c2.4-3.199,5.2-4.398,8.4-3.599 c1.826,0.456,3.131,1.781,4.576,3.247C27.328,21.236,30.051,24,36,24c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.6 c-1.825-0.456-3.13-1.781-4.575-3.247C32.672,12.367,29.948,9.604,24,9.604L24,9.604z M12,24c-6.4,0-10.4,3.199-12,9.598 c2.4-3.199,5.2-4.399,8.4-3.599c1.825,0.457,3.13,1.781,4.575,3.246c2.353,2.388,5.077,5.152,11.025,5.152 c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.599c-1.826-0.456-3.131-1.781-4.576-3.246C20.672,26.764,17.949,24,12,24 L12,24z" />
                    </svg>
                    <div class="q-mt-sm text-h4">TAILWIND</div>

                </q-carousel-slide>
                <q-carousel-slide name="bootstrap" class="column no-wrap flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="80px" height="80px">
                        <path fill="#673ab7"
                    ...
                    <div class="q-mt-sm text-h4">BOOTSTRAP</div>
